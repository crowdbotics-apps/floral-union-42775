"""
Django settings for floral_union_42775 project.
...
ROOT_URLCONF = 'floral_union_42775.urls'
...
WSGI_APPLICATION = 'floral_union_42775.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "floral_union_42775 API",
    "DESCRIPTION": "API documentation for floral_union_42775 App",
    "VERSION": "v1",
}
